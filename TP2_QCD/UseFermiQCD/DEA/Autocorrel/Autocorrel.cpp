...
//set legend for g0
    ...
    GracePrintf ("legend 0.2,0.9");
    GracePrintf ("s0 legend \"<5x4 loop> hot start\" ");
//g1
    GracePrintf( "with g1");
    GracePrintf("autoscale onread none");
    GracePrintf ("world xmin 0");
...
//// ITERATION CONTROL //
/////////////////////////
  int decorel=1,nheat=200;       // decorrelation and heating
...
//////////////////////////////////
  int mu=0,nu=1,t=5,z=4;  //loop plane and size
