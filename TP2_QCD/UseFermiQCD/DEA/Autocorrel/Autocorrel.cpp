...
//   Close GRACE or pipe
  //  if (//GraceIsOpen()) {
        ...
        //GracePrintf ("saveall \"Autocorrel.agr\"");
...
//// LATTICE DEFINITION ///
///////////////////////////
  int timesize=16,spacesize3=12,spacesize2=6,spacesize1=6;
  int box[]={timesize,spacesize3,spacesize2,spacesize1};
...
//// ITERATION CONTROL //
/////////////////////////
  int decorel=5,nheat=800;       // decorrelation and heating
  int maxiter=2000,niter=1000;
  int test, k;
  float rk;
...
//////////////////////////////////
  int mu=0,nu=1,t=5,z=5;  //loop plane and size
...
//HEATING
   for(k=1; k<=nheat  ; k++)
 //  {sprintf(gracetitle,"title \" doing %d heating steps: %d\"",nheat,k);
...
// COMPUTES THE LOOPS AT TIME k
   	store_loop[k]=my_average_loop(U,mu,t,nu,z);
...
// EXIT //
//////////
//system("xmessage -center  save Grace file Autocorrel.agr and then exit?");
//
//EndGrace();
//
 mdp.close_wormholes();
